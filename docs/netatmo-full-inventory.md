...
| 815666668 | Bagno Vasca | bathroom | `xx:xx:xx:xx:xx:e0` (NRV) |
...
| 2220668919 | Bagno Doccia | toilets | `xx:xx:xx:xx:xx:fa` (NRV) |
...
| 2171004425 | **Termostato** | livingroom | `xx:xx:xx:xx:xx:e0` (BNS Smarther) |
...
|---|---|---|---|---|---|
| `xx:xx:xx:xx:xx:e0` | **Termostato** | **BNS** | – (gateway) | Termostato | wifi 63, boiler_status=true, cooler_status=false, comfort_boost=false |
| `xx:xx:xx:xx:xx:e0` | Radiatore Bagno Vasca | **NRV** | BNS | Bagno Vasca | battery full 3011mV, rf 57 |
| `xx:xx:xx:xx:xx:fa` | Radiatore Bagno Doccia | **NRV** | BNS | Bagno Doccia | battery full 3066mV, rf 47 |

**Smarther 2** = `xx:xx:xx:xx:xx:e0` type **BNS**, room `2171004425` ("Termostato"). Unico modulo BNS.
...
|---|---|---|---|---|
| `xx:xx:xx:xx:xx:d2` | Gateway | NLG | Ingresso | wifi 59, firmware 1303 |
| `xx:xx:xx:xx:xx:cc:88:f5` | Home Away | NLT | Ingresso | NLT (presence?) battery full |
| `xx:xx:xx:xx:xx:cc:69:91` | Tapparelle Wifi Salone Sinistra | NLT | Salone | battery full, reachable=false |
| `xx:xx:xx:xx:xx:cc:69:73` | Tapparelle Wifi Studio Fabio Sinistra | NLT | Studio Fabio | battery full |
| `xx:xx:xx:xx:xx:cc:9d:15` | Tapparella Wifi Camera da letto | NLT | Camera da letto | battery full 2900mV |
| `xx:xx:xx:xx:xx:cc:9d:da` | Tapparella Wifi Cucina | NLT | Cucina | battery full, reachable=false |
| `xx:xx:xx:xx:xx:cc:69:5c` | Tapparella Wifi Studio Lida | NLT | Studio Lida | battery full |
| `xx:xx:xx:xx:xx:cc:69:63` | Tapparella Wifi Salone Destra | NLT | Salone | battery full 3100mV |
| `xx:xx:xx:xx:xx:cc:9d:29` | Tapparella Wifi Studio Fabio Destra | NLT | Studio Fabio | battery full, reachable=false |
| `xx:xx:xx:xx:xx:48:98:80` | Tapparella Cucina | **NLLV** | Cucina | pos 43/43 |
| `xx:xx:xx:xx:xx:48:97:f5` | Tende Salone Sinistra | NLLV | Salone | pos 50/50 |
| `xx:xx:xx:xx:xx:48:68:27` | Tapparelle Bagno Vasca | NLLV | Bagno Vasca | pos 100/100 |
| `xx:xx:xx:xx:xx:48:68:98` | Tapparelle Salone Sinistra | NLLV | Salone | pos 0/0 |
| `xx:xx:xx:xx:xx:48:68:b4` | Tapparelle Camera da Letto | NLLV | Camera da letto | pos 23/23 |
| `xx:xx:xx:xx:xx:48:98:e4` | Tapparelle Studio Lida | NLLV | Studio Lida | pos 55/55 |
| `xx:xx:xx:xx:xx:48:68:ca` | Tapparelle Studio Fabio Sinistra | NLLV | Studio Fabio | pos 52/52 |
| `xx:xx:xx:xx:xx:48:98:0e` | Tapparelle Studio Fabio Destra | NLLV | Studio Fabio | pos 100/100 |
| `xx:xx:xx:xx:xx:48:68:30` | Tende Salone Destra | NLLV | Salone | pos 0/0 |
| `xx:xx:xx:xx:xx:48:97:82` | Tapparelle Salone Destra | NLLV | Salone | pos 100/100 |
| `xx:xx:xx:xx:xx:5e:b6:f5` | Corridoio (luce) | NLL | Corridoio | off |
| `xx:xx:xx:xx:xx:5e:bb:8b` | Bagno Doccia (luce) | NLL | Bagno Doccia | off |
| `xx:xx:xx:xx:xx:5e:b7:8f` | Luce Bagno Vasca | NLL | Bagno Vasca | off |
| `xx:xx:xx:xx:xx:5e:bb:a7` | Luce Studio Lida | NLL | Studio Lida | off |
| `xx:xx:xx:xx:xx:5e:ba:f1` | Luce Cabina Armadio | NLL | Cabina Armadio | off |
| `xx:xx:xx:xx:xx:5e:b6:fb` | Luce Balcone | NLL | Balcone Grande | off |
| `xx:xx:xx:xx:xx:5e:b6:eb` | Luce Cucina | NLL | Cucina | off |
| `xx:xx:xx:xx:xx:5e:b6:d9` | Luce Penisola | NLL | Cucina | off |
| `xx:xx:xx:xx:xx:5e:bb:83` | Luce Studio Fabio | NLL | Studio Fabio | off |
| `xx:xx:xx:xx:xx:5e:bb:bd` | Luce Ingresso | NLL | Ingresso | off |
| `xx:xx:xx:xx:xx:5e:b6:91` | Luce Balcone Camera da Letto | NLL | Balcone Camera | off |
| `xx:xx:xx:xx:xx:72:79:7e` | Luce Tavolo | NLFN | Salone | off, dim 8 |
| `xx:xx:xx:xx:xx:72:79:4a` | Luce Camera da Letto | NLFN | Camera da letto | off, dim 100 |
| `xx:xx:xx:xx:xx:cc:69:6a` | _(senza nome)_ | **NLunknown** | – | firmware 0xFFFFFFFF, no room |
...
4. **Smarther 2**: `xx:xx:xx:xx:xx:e0` (type BNS), room `2171004425` ("Termostato", type livingroom). Stato live: `boiler_status:true` (relè caldaia chiamato ma `heating_power_request:0` → contraddizione minore, probabile lag), `cooler_status:false`, wifi 63.
5. **NRV bagni**: 2 — Bagno Vasca (`xx:xx:xx:xx:xx:e0`) e Bagno Doccia (`xx:xx:xx:xx:xx:fa`). Entrambi battery full, reachable, RF 47-57. Setpoint 7°C (antigelo) entrambi → caloriferi spenti.
6. **Altri HVAC**: nessuno. Sotto il bridge BNS solo Smarther + 2 NRV. Tutto il resto è domotica (NLG tree).

## Caveat

- Il modulo `xx:xx:xx:xx:xx:cc:69:6a` type `NLunknown` non lo so identificare con certezza dai dati API — verificare in app Bticino se è ancora paired.
